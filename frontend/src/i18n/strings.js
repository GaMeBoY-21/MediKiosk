...
export const strings = {
  en: {
    ...
    consent: {
      ...
      optGovernment: { label: 'Share my health record with government health programmes', audio: 'Share my health record with government health programmes.' },
  ...
  hi: {
    ...
    consent: {
      ...
      optGovernment: { label: 'मेरा स्वास्थ्य रिकॉर्ड सरकारी स्वास्थ्य कार्यक्रमों के साथ साझा करें', audio: 'मेरा स्वास्थ्य रिकॉर्ड सरकारी स्वास्थ्य कार्यक्रमों के साथ साझा करें।' },
  ...
  kn: {
    ...
    consent: {
      ...
      optGovernment: { label: 'ನನ್ನ ಆರೋಗ್ಯ ದಾಖಲೆಯನ್ನು ಸರ್ಕಾರಿ ಆರೋಗ್ಯ ಕಾರ್ಯಕ್ರಮಗಳೊಂದಿಗೆ ಹಂಚಿಕೊಳ್ಳಿ', audio: 'ನನ್ನ ಆರೋಗ್ಯ ದಾಖಲೆಯನ್ನು ಸರ್ಕಾರಿ ಆರೋಗ್ಯ ಕಾರ್ಯಕ್ರಮಗಳೊಂದಿಗೆ ಹಂಚಿಕೊಳ್ಳಿ.' },
  ...
  ta: {
    ...
    consent: {
      ...
      optGovernment: { label: 'என் உடல்நல பதிவை அரசு சுகாதாரத் திட்டங்களுடன் பகிரவும்', audio: 'என் உடல்நல பதிவை அரசு சுகாதாரத் திட்டங்களுடன் பகிரவும்.' },
  ...
  te: {
    ...
    consent: {
      ...
      optGovernment: { label: 'నా ఆరోగ్య రికార్డును ప్రభుత్వ ఆరోగ్య కార్యక్రమాలతో పంచుకోండి', audio: 'నా ఆరోగ్య రికార్డును ప్రభుత్వ ఆరోగ్య కార్యక్రమాలతో పంచుకోండి.' },
  ...
  mr: {
    ...
    consent: {
      ...
      optGovernment: { label: 'माझी आरोग्य नोंद सरकारी आरोग्य कार्यक्रमांसोबत सामायिक करा', audio: 'माझी आरोग्य नोंद सरकारी आरोग्य कार्यक्रमांसोबत सामायिक करा.' },
  ...
  bn: {
    ...
    consent: {
      ...
      optGovernment: { label: 'আমার স্বাস্থ্য নথি সরকারি স্বাস্থ্য কর্মসূচির সাথে ভাগ করুন', audio: 'আমার স্বাস্থ্য নথি সরকারি স্বাস্থ্য কর্মসূচির সাথে ভাগ করুন।' },
