...
export const strings = {
  en: {
    ...
    consent: {
      ...
      choicesTitle: { label: 'What may we do?', audio: 'Please choose what you allow us to do.' },
      explanation: {
        label:
  ...
  hi: {
    ...
    consent: {
      ...
      choicesTitle: { label: 'हम क्या कर सकते हैं?', audio: 'कृपया चुनिए कि आप हमें क्या करने की अनुमति देते हैं।' },
      explanation: {
        label:
  ...
  kn: {
    ...
    consent: {
      ...
      choicesTitle: { label: 'ನಾವು ಏನು ಮಾಡಬಹುದು?', audio: 'ದಯವಿಟ್ಟು ನಾವು ಏನು ಮಾಡಬಹುದು ಎಂದು ಆಯ್ಕೆಮಾಡಿ.' },
      explanation: {
        label:
  ...
  ta: {
    ...
    consent: {
      ...
      choicesTitle: { label: 'நாங்கள் என்ன செய்யலாம்?', audio: 'நாங்கள் என்ன செய்யலாம் என்பதைத் தேர்ந்தெடுக்கவும்.' },
      explanation: {
        label:
  ...
  te: {
    ...
    consent: {
      ...
      choicesTitle: { label: 'మేము ఏమి చేయవచ్చు?', audio: 'మేము ఏమి చేయవచ్చో దయచేసి ఎంచుకోండి.' },
      explanation: {
        label:
  ...
  mr: {
    ...
    consent: {
      ...
      choicesTitle: { label: 'आम्ही काय करू शकतो?', audio: 'कृपया आम्ही काय करू शकतो ते निवडा.' },
      explanation: {
        label:
  ...
  bn: {
    ...
    consent: {
      ...
      choicesTitle: { label: 'আমরা কী করতে পারি?', audio: 'অনুগ্রহ করে বেছে নিন আমরা কী করতে পারি।' },
      explanation: {
        label:
